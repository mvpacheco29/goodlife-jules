...
export const metadata: Metadata = {
  title: 'Contato - GoodLife Seguros',
  description: 'Entre em contato com a GoodLife Seguros. Estamos prontos para atender você e tirar todas as suas dúvidas sobre seguros.',
};
...
const ContatoPage: React.FC = () => {
  // Placeholder para a função de envio do formulário
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    // Lógica de envio do formulário virá na Fase 3
    alert('Formulário enviado (simulação)! A funcionalidade de envio será implementada na Fase 3.');
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg border border-borderLight">
          ...
          <div className="space-y-6 text-textMuted">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <a href="tel:+55XXYYYYYZZZZ" className="hover:text-accent">(XX) XXXXX-ZZZZ</a>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <a href="https://wa.me/55XXYYYYYZZZZ" target="_blank" rel="noopener noreferrer" className="hover:text-accent">(XX) XXXXX-ZZZZ</a>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <a href="mailto:contato@goodlifeseguros.com.br" className="hover:text-accent">contato@goodlifeseguros.com.br</a>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="aspect-w-16 aspect-h-9 bg-gray-200 rounded-md flex items-center justify-center text-gray-500">
              ...
              {/* Exemplo de iframe (substituir src pelo seu link real do Google Maps):
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.1457000000003!2d-46.65682708440673!3d-23.56409526759698!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59c8da0aa315%3A0x200c8f0b90a0d87!2sAv.%20Paulista%2C%20S%C3%A3o%20Paulo%20-%20SP!5e0!3m2!1spt-BR!2sbr!4v1623456789012!5m2!1spt-BR!2sbr"
                width="100%"
                height="300"
                style={{ border:0 }}
                allowFullScreen={true}
                loading="lazy"
                title="Localização da GoodLife Seguros"
              ></iframe>
              */}
            </div>
          </div>
        ...
        <div className="bg-white p-8 rounded-lg shadow-lg border border-borderLight">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input type="text" name="name" id="name" required className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-accent focus:border-accent" />
            </div>
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-textMuted mb-1">Email</label>
              <input type="email" name="email" id="email" required className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-accent focus:border-accent" />
            </div>
            <div>
              <label htmlFor="phone" className="block text-sm font-medium text-textMuted mb-1">Telefone (Opcional)</label>
              <input type="tel" name="phone" id="phone" className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-accent focus:border-accent" />
            </div>
            <div>
              <label htmlFor="subject" className="block text-sm font-medium text-textMuted mb-1">Assunto</label>
              <input type="text" name="subject" id="subject" required className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-accent focus:border-accent" />
            </div>
            <div>
              <label htmlFor="message" className="block text-sm font-medium text-textMuted mb-1">Sua Mensagem</label>
              <textarea name="message" id="message" rows={5} required className="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-accent focus:border-accent"></textarea>
            </div>
            <div>
              <button
                type="submit"
                className="w-full bg-accent hover:bg-accent-hover text-white font-bold py-3 px-6 rounded-md transition duration-300"
              >
                Enviar Mensagem
              </button>
            </div>
